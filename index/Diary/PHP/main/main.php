            ...
            <div class="main">
                <div class="youtube">
                    ...
                    <div class="youtube_cont">
                        <div class="youtube_cont_item_01">
                            <img src="../assets/img/youtube_play_icon.png" alt="">
                            <img src="../assets/img/youtube_thumb_01.png" alt="">
                            <p>TIP</p>
                            <h2>안녕하세요</h2>
                            <p>너만 모르는 한가지 사실...!</p>
                        </div>
                ...
                <div class="notice">
                    ...
                    <p>테스트</p>
                    <img class="cross" src="../assets/img/site_main_cross.png" alt="">
                    <div class="notice_desc_cont">
                        <div class="notice_quick_cont"></div>
                        <div class="notice_list_cont"></div>
                    </div>
                </div>
            </div>
        </div>
